...
async function sendMessage() {
    ...
    try {
        const response = await fetch("https://api.openai.com/v1/chat/completions", {
            method: "POST",
            headers: {
                "Authorization": `Bearer ${apiKey}`,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
